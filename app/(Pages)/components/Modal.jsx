    ...
    return (
        (showModal && <div className="font-display fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                ...
                <form className="p-6 space-y-5" onSubmit={hnadleaddproduct}>
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button className="flex-1 py-2.5 px-4 bg-[#81e240] text-slate-900 rounded-lg font-bold text-sm shadow-lg shadow-[#81e240]/20 hover:scale-[1.02] active:scale-[0.98] transition-all" type="submit">Create Product</button>
                    </div>
                </form>
            </div>
        </div>)
